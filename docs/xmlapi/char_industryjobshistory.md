...
* This endpoint returns finished character jobs (e.g. started from a personal hangar).  Use <a href="../../xmlapi/char_industryjobs">Char - IndustryJobs</a> to retrieve unfinished jobs.
