...
* This endpoint returns finished corporation jobs (e.g. started from a corporation hangar).  Use <a href="../../xmlapi/corp_industryjobs">Corp - IndustryJobsHistory</a> to retrieve unfinished jobs.
