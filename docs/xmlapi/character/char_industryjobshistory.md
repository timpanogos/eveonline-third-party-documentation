...
* This endpoint returns finished character jobs (e.g. started from a personal hangar).  Use <a href="char_industryjobs.html">Character - IndustryJobs</a> to retrieve unfinished jobs.
